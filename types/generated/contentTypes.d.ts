...
export interface ApiComponenteCurricularComponenteCurricular
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    turmas: Attribute.Relation<
      'api::componente-curricular.componente-curricular',
      'oneToMany',
      'api::turma.turma'
    >;
    grade_componentes: Attribute.Relation<
      'api::componente-curricular.componente-curricular',
      'oneToMany',
      'api::grade-componente.grade-componente'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCursoCurso extends Schema.CollectionType {
  ...
  attributes: {
    nome: Attribute.String & Attribute.Required;
    grades_curriculares: Attribute.Relation<
      'api::curso.curso',
      'oneToMany',
      'api::grade-curricular.grade-curricular'
    >;
    discentes: Attribute.Relation<
      'api::curso.curso',
      'oneToMany',
      'api::discente.discente'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiDiscenteDiscente extends Schema.CollectionType {
...
export interface ApiDocenteDocente extends Schema.CollectionType {
  ...
  attributes: {
    siape: Attribute.UID & Attribute.Required;
    nome: Attribute.String & Attribute.Required;
    turmas: Attribute.Relation<
      'api::docente.docente',
      'manyToMany',
...
export interface ApiGradeComponenteGradeComponente
  extends Schema.CollectionType {
  ...
  attributes: {
    grade_curricular: Attribute.Relation<
      ...
      'api::grade-curricular.grade-curricular'
    >;
    componente_curricular: Attribute.Relation<
      'api::grade-componente.grade-componente',
      'manyToOne',
      'api::componente-curricular.componente-curricular'
    >;
    periodo: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiGradeCurricularGradeCurricular
  extends Schema.CollectionType {
...
export interface ApiMatriculaMatricula extends Schema.CollectionType {
  ...
  attributes: {
    ...
    discente: Attribute.Relation<
      'api::matricula.matricula',
      'manyToOne',
      'api::discente.discente'
    >;
    turma: Attribute.Relation<
      'api::matricula.matricula',
      'manyToOne',
      'api::turma.turma'
    >;
...
export interface ApiTurmaTurma extends Schema.CollectionType {
  ...
  attributes: {
    ...
    capacidade: Attribute.Integer;
    vagas_preenchidas: Attribute.Integer & Attribute.DefaultTo<0>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::componente-curricular.componente-curricular': ApiComponenteCurricularComponenteCurricular;
      'api::curso.curso': ApiCursoCurso;
      'api::discente.discente': ApiDiscenteDiscente;
      'api::docente.docente': ApiDocenteDocente;
      'api::grade-componente.grade-componente': ApiGradeComponenteGradeComponente;
      'api::grade-curricular.grade-curricular': ApiGradeCurricularGradeCurricular;
